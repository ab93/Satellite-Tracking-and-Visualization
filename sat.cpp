...
char	qthfile[50], tlefile[50], dbfile[50], temp[80], output[25],
        ...
        calc_squint, xterm,once_per_second=0,database=0, io_lat='N', io_lon='W';
...
/* All get functions to fetch data and records */

void Sat::getSatelliteList()    //Function to get all the satellite list names
{
    ...
    {
            if (sat[i].name[0]!=0)
                    strcat((char*)buff,(const char*)sat[i].name);
...
void Sat::getTLE(char* satname)   //Function to get the TLE from the satellite names
{
    int i,j;
...
void Sat::getDoppler(char *satname)
{
    int i,j;
...
void Sat::getTime$()
{
    unsigned char buff[1000];
    time_t t=time(NULL);
    sprintf((char*)buff,"%s",asctime(gmtime(&t)));
...
void Sat::getTime()
{
    unsigned char buff[1000];
    time_t t=time(NULL);
    sprintf((char*)buff,"%lu\n",(unsigned long)t);
    printf("\n%s",buff);
}

void Sat::getSatellitePosition(char* satname)
{
    /* Send request to predict with output
                               directed to a temporary file under /tmp */

    char tempname[30],buff[1000];
    char *predict_name;
    int i,j;
...
int Sat::isFlagSet(int flag)
{
        return (Flags&flag);
}

int Sat::isFlagClear(int flag)
{
        return (~Flags&flag);
}

void Sat::SetFlag(int flag)
{
        Flags|=flag;
}

void Sat::ClearFlag(int flag)
{
        Flags&=~flag;
}
...
double Sat::Sqr(double arg)
{
        /* Returns square of a double */
        return (arg*arg);
}

double Sat::Cube(double arg)
{
        /* Returns cube of a double */
        return (arg*arg*arg);
}

double Sat::Radians(double arg)
{
        /* Returns angle in radians from argument in degrees */
        return (arg*deg2rad);
}

double Sat::Degrees(double arg)
{
        /* Returns angle in degrees from argument in radians */
        return (arg/deg2rad);
}

double Sat::ArcSin(double arg)
{
...
double Sat::ArcCos(double arg)
{
        /* Returns arccosine of argument */
        return(pio2-ArcSin(arg));
}

void Sat::Magnitude(vector_t *v)
{
        /* Calculates scalar magnitude of a vector_t argument */
        v->w=sqrt(Sqr(v->x)+Sqr(v->y)+Sqr(v->z));
}

void Sat::Vec_Add(vector_t *v1, vector_t *v2, vector_t *v3)
{
...
void Sat::Vec_Sub(vector_t *v1, vector_t *v2, vector_t *v3)
{
...
void Sat::Scalar_Multiply(double k, vector_t *v1, vector_t *v2)
{
...
void Sat::Scale_Vector(double k, vector_t *v)
{
...
double Sat::Dot(vector_t *v1, vector_t *v2)
{
        /* Returns the dot product of two vectors */
        return (v1->x*v2->x+v1->y*v2->y+v1->z*v2->z);
}

double Sat::Angle(vector_t *v1, vector_t *v2)
{
...
void Sat::Cross(vector_t *v1, vector_t *v2 ,vector_t *v3)
{
...
double Sat::AcTan(double sinx, double cosx)
{
...
double Sat::Modulus(double arg1, double arg2)
{
...
double Sat::Julian_Date_of_Year(double year)
{
...
double Sat::Julian_Date_of_Epoch(double epoch)
{
...
int Sat::DOY (int yr, int mo, int dy)
{
...
double Sat::Fraction_of_Day(int hr, int mi, double se)
{
...
double Sat::Julian_Date(struct tm *cdate)
{
...
void Sat::Date_Time(double julian_date, struct tm *cdate)
{
...
double Sat::Delta_ET(double year)
{
...
double Sat::ThetaG(double epoch, deep_arg_t *deep_arg)
{
...
double Sat::ThetaG_JD(double jd)
{
        /* Reference:  The 1992 Astronomical Almanac, page B6. */
...
void Sat::Calculate_Solar_Position(double time, vector_t *solar_vector)
{
...
int Sat::Sat_Eclipsed(vector_t *pos, vector_t *sol, double *depth)
{
...
void Sat::select_ephemeris(tle_t *tle)
{
...
void Sat::SGP4(double tsince, tle_t * tle, vector_t * pos, vector_t * vel)
{
...
void Sat::Deep(int ientry, tle_t * tle, deep_arg_t * deep_arg)
{
...
void Sat::SDP4(double tsince, tle_t * tle, vector_t * pos, vector_t * vel)
{
        /* This function is used to calculate the position and velocity */
...
void Sat::Calculate_User_PosVel(double time, geodetic_t *geodetic, vector_t *obs_pos, vector_t *obs_vel)
{
...
void Sat::Calculate_LatLonAlt(double time, vector_t *pos,  geodetic_t *geodetic)
{
...
void Sat::Calculate_Obs(double time, vector_t *pos, vector_t *vel, geodetic_t *geodetic, vector_t *obs_set)
{
...
void Sat::Calculate_RADec(double time, vector_t *pos, vector_t *vel, geodetic_t *geodetic, vector_t *obs_set)
{
...
void Sat::TrackDataOut(int antfd, double elevation, double azimuth)
{
...
int Sat::passivesock(char *service, char *protocol, int qlen)
{
...
void Sat::socket_server(char *predict_name)
{
...
double Sat::PrimeAngle(double x)
{
...
char Sat::*SubString(char *string,int start,int end)
{
...
void Sat::CopyString(char *source,char *destination,int start,int end)
{
...
char Sat::*Abbreviate(char *string,int n)
{
...
char Sat::KepCheck(char *line1,char *line2)
{
...
char Sat::*noradEvalue(double value)
{
...
double Sat::ReadBearing(char *input)
{
...
char Sat::CopyFile(char *source,char *destination)
{
...
int Sat::AutoUpdate(char *string)
{
...
long Sat::DayNum(int m,int d,int y)
{
...
char Sat::*Daynum2String(double daynum)
{
...
double Sat::GetStartTime(char mode)
{
...
void Sat::FindMoon(double daynum)
{
...
void Sat::FindSun(double daynum)
{
...
void Sat::Calc()
{
        ...
        //**** Print position and velocity of the satellite ****//
...
char Sat::Decayed(int x,double time)
{
...
int Sat::Print(char *string,char mode)
{
...
int Sat::PrintVisible(char *string)
{
...
vector_t Sat::ReturnPositionCoordinates()
{
        /* This is the stuff we need to do repetitively while tracking. */
        ...
        //****** For incrementing speed ******* //

        tsince = tsince + (COUNT * 1.0);
...
//**** Own function to get the x,y,z coordinates of the satellite ****//

vector_t Sat::getSatelliteCoordinates(int x)
{
    ...
    if (xterm)
            printf("PREDICT: Tracking %-10s\007\n",sat[x].name);
    halfdelay(2);
    curs_set(0);
    bkgdset(COLOR_PAIR(3));
    clear();
    ...
    do
    {
            ...
            pos = ReturnPositionCoordinates();

            if(COUNT == 1)
            {
                SingleTrackChanged(x);
...
void Sat::SingleTrackChanged(int x)
{
    ...
    if (xterm)
            printf("\033]0;PREDICT: Tracking %-10s\007\n",sat[x].name);
    halfdelay(2);
    curs_set(0);
    bkgdset(COLOR_PAIR(3));
    clear();
    ...
    do
    {
            ...
            printf("Altitude(m): %0.f\n",sat_alt*km2mi);
            printf("Altitude(km): %0.f\n",sat_alt);
            printf("Slant range(m): %-5.0f\n",sat_range*km2mi);
            printf("Slant range(km): %-5.0f\n",sat_range);

            printf("Longitude: %-7.2f\n",(io_lon=='W'?360.0-sat_lon:sat_lon));
            printf("Azimuth: %-7.2f\n",sat_azi);
            printf("Elevation: %+-6.2f\n",sat_ele);
            printf("Velocity(m): %0.f\n",(3600.0*sat_vel)*km2mi);
            printf("Velocity(km): %0.f\n",3600.0*sat_vel);
...
void Sat::SingleTrack(int x,char speak)
{
        ...
        if (xterm)
                ...
                printf("\033]0;PREDICT: Tracking %-10s\007",sat[x].name);
        halfdelay(2);
        curs_set(0);
        bkgdset(COLOR_PAIR(3));
        clear();
...
int Sat::QuickFind(char *string,char *outputfile)
{
        int x, y, z, step=1;
...
int Sat::QuickPredict(char *string,char *outputfile)
{
        int x, y, z, lastel=0;
        long start, now;
...
void Sat::startProcess()    // Function to read TLE files and do other initializations
{
    int x, y, z, key=0;
...
//                }
    ...
    if (x==3)
    {
          ...
          //  MainMenu();
            ...
            getTime$();
            getTime();
            getSatellitePosition("OSCAR-7");
           // SingleTrackChanged(22);
            //exit(0);
