...
//char *predictpath={"/home/trainee/orbital_mechanics/predict-2.2.3/"};
...
static int COUNT = 0;
static float speedFactor = 0.1;
static bool isChanged = false;
static double tsince_temp = 0.0;
static double sat_daynum;

void getSatelliteList();
//char* getSatelliteList();
